...
export const CASES_CREATE_CASEFILE_RESPONDENT_DETAILS_FIELD_ERRORS: ICasesCreateCasefileRespondentDetailsFieldErrors = {
  create_casefile_respondent_details_title: createCasesCreateCasefileMaxLengthError('Title', 20, 2),
  ...
  create_casefile_respondent_details_alias_first_names_0: {
  ...
  create_casefile_respondent_details_alias_last_name_0: {
  ...
  create_casefile_respondent_details_alias_first_names_1: {
  ...
  create_casefile_respondent_details_alias_last_name_1: {
  ...
  create_casefile_respondent_details_alias_first_names_2: {
  ...
  create_casefile_respondent_details_alias_last_name_2: {
  ...
  create_casefile_respondent_details_alias_first_names_3: {
  ...
  create_casefile_respondent_details_alias_last_name_3: {
  ...
  create_casefile_respondent_details_alias_first_names_4: {
  ...
  create_casefile_respondent_details_alias_last_name_4: {
  ...
  create_casefile_respondent_details_date_of_birth: {
  ...
  create_casefile_respondent_details_national_insurance_number: {
    nationalInsuranceNumberPattern: createCasesCreateCasefileError(
      'Enter a National Insurance number in the format AANNNNNNA',
      1,
    ),
  },
  create_casefile_respondent_details_other_personal_information: createCasesCreateCasefileMaxLengthError(
    'Other personal information',
    200,
    2,
  ),
  create_casefile_respondent_details_main_email_address: {
  ...
  create_casefile_respondent_details_main_telephone_number: createCasesCreateCasefileMaxLengthError(
    'Main telephone number',
    35,
    2,
  ),
  create_casefile_respondent_details_other_telephone_number: createCasesCreateCasefileMaxLengthError(
  ...
  create_casefile_respondent_details_address_line_2: createCasesCreateCasefileMaxLengthError('Address line 2', 30, 2),
  create_casefile_respondent_details_address_line_3: createCasesCreateCasefileMaxLengthError('Address line 3', 30, 2),
  create_casefile_respondent_details_address_line_4: createCasesCreateCasefileMaxLengthError('Address line 4', 30, 2),
  create_casefile_respondent_details_address_line_5: createCasesCreateCasefileMaxLengthError('Address line 5', 30, 2),
  create_casefile_respondent_details_postal_or_zip_code: createCasesCreateCasefileMaxLengthError(
    'Postal or zip code',
    10,
    2,
  ),
  ...
  create_casefile_respondent_details_third_party_reference: createCasesCreateCasefileMaxLengthError('Reference', 40, 2),
  create_casefile_respondent_details_third_party_address_line_1: {
    required: createCasesCreateCasefileError('Enter an address', 1),
    ...createCasesCreateCasefileMaxLengthError('Address line 1', 30, 2),
  },
  create_casefile_respondent_details_third_party_address_line_2: createCasesCreateCasefileMaxLengthError(
    'Address line 2',
    30,
    2,
  ),
  create_casefile_respondent_details_third_party_address_line_3: createCasesCreateCasefileMaxLengthError(
    'Address line 3',
    30,
    2,
  ),
  create_casefile_respondent_details_third_party_address_line_4: createCasesCreateCasefileMaxLengthError(
    'Address line 4',
    30,
    2,
  ),
  create_casefile_respondent_details_third_party_address_line_5: createCasesCreateCasefileMaxLengthError(
    'Address line 5',
    30,
    2,
  ),
  create_casefile_respondent_details_third_party_postal_or_zip_code: createCasesCreateCasefileMaxLengthError(
    'Postal or zip code',
    10,
    2,
  ),
  ...
  create_casefile_respondent_details_employee_reference: createCasesCreateCasefileMaxLengthError(
    'Employee reference',
    20,
    2,
  ),
  ...
  create_casefile_respondent_details_employer_telephone_number: createCasesCreateCasefileMaxLengthError(
  ...
  create_casefile_respondent_details_employer_address_line_2: createCasesCreateCasefileMaxLengthError(
    'Address line 2',
    30,
    2,
  ),
  create_casefile_respondent_details_employer_address_line_3: createCasesCreateCasefileMaxLengthError(
    'Address line 3',
    30,
    2,
  ),
  create_casefile_respondent_details_employer_address_line_4: createCasesCreateCasefileMaxLengthError(
    'Address line 4',
    30,
    2,
  ),
  create_casefile_respondent_details_employer_address_line_5: createCasesCreateCasefileMaxLengthError(
    'Address line 5',
    30,
    2,
  ),
  create_casefile_respondent_details_employer_postal_or_zip_code: createCasesCreateCasefileMaxLengthError(
    'Postal or zip code',
    10,
    2,
  ),
